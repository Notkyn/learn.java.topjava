                ...
                <form id="filter">
                    <div class="row">
                        <div class="offset-1 col-2">
                            ...
                            <input type="text" class="form-control datePicker" id="startDateFilter" name="startDate">
                        </div>
                        <div class="col-2">
                            <label for="endDateFilter"><spring:message code="meal.endDate"/>:</label>
                            <input type="text" class="form-control datePicker" id="endDateFilter" name="endDate">
                        </div>
                        <div class="offset-2 col-2">
                            <label for="startTimeFilter"><spring:message code="meal.startTime"/>:</label>
                            <input type="text" class="form-control timePicker" id="startTimeFilter" name="startTime">
                        </div>
                        <div class="col-2">
                            <label for="endTimeFilter"><spring:message code="meal.endTime"/>:</label>
                            <input type="text" class="form-control timePicker" id="endTimeFilter" name="endTime">
                        </div>
                    </div>
                </form>
            </div>
